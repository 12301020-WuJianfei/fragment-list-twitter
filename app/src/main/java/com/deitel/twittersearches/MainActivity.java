...
public class MainActivity extends Activity implements TlistFragment.OnFragmentInteractionListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        getFragmentManager().beginTransaction()
                .add(R.id.fragment_holder,new TlistFragment())
                .commit();
    ...
    public void sendToSecondFrag(String query) {
        ...
        getFragmentManager().beginTransaction()
                .replace(R.id.fragment_holder, WebFragment.newInstance(urlString))
                .addToBackStack(null)
                .commit();
    }
